...
export default function MainPage() {
    ...
    if (selectedLocationData.region) {
        url.pathname += `api/${selectedLocationData.region}/`;
        if (selectedLocationData.province) {
            url.pathname += `${selectedLocationData.province}/`;
            if (selectedLocationData.cityMunicipality) {
                url.pathname += `${selectedLocationData.cityMunicipality}`;
                if (selectedLocationData.hotline) {
